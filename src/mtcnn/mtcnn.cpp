...
//--------------------------------------------------------------
// remove duplicate proposals. it have intersection-over-union (IOU) > threshold
//--------------------------------------------------------------
...
//--------------------------------------------------------------
// create scale pyramid . list of scale window
// factor : scale of pyramid
// minsize : minimum size of face detected
//--------------------------------------------------------------
...
{	
	...
	// it ensure window can split to 12 part
